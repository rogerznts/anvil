...
After the explanation is complete, spawn one architectural critic per model in your configured how-critics list in `.claude/rules/anvil.md` (defaults `opus`, `fable`, `sonnet`), all in a single message.
