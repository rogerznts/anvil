...
- `docs/architecture/context.md` and `docs/architecture/context-map.md`
- `docs/architecture/adr/` and any `src/*/docs/adr/` directories
...
**Section C: Domain docs.** Default to **single-context** (one `docs/architecture/context.md` + `docs/architecture/adr/`). This fits almost every repo; write it without asking.

Offer **multi-context** (a `docs/architecture/context-map.md` pointing to per-context `CONTEXT.md` files) only when exploration found monorepo signals. Then confirm which layout they want.
