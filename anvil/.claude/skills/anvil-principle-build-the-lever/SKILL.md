---
name: anvil-principle-build-the-lever
...
**Balance:** The bar is triviality, not repetition. A one-off still earns a lever when the lever is what makes the work checkable. Per the the **anvil-principle-laziness-protocol** skill, build the smallest script that does or proves the job, never a framework.

Distinct from the **anvil-principle-encode-lessons-in-structure** skill, which makes a recurring instruction a durable guardrail. This is throughput and reviewability on the work in front of you. For scripting the verification itself, see the **anvil-principle-prove-it-works** skill.
