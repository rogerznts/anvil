...
1. Route through the **anvil-how** skill (Explain mode for narrow questions, Critique mode for "are we sure?"). For motivation questions, dig into git history and the ADRs under `docs/architecture/adr/`.
