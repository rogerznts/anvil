...
- [004 — Robustez e isolamento da camada omp](./specs/004-extension-omp-layer-hardening/spec.md) — `extension/004-omp-layer-hardening`, em andamento, 0/11 tickets resolvidos
