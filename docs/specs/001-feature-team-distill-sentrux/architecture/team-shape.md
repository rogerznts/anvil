...
`git rev-parse --show-toplevel` do worktree ao começar e confere antes de cada
escrita e de cada commit, e fora dele volta `BLOQUEADO` sem escrever (RV2-F1 do
