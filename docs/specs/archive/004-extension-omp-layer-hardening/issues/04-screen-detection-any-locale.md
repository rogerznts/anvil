...
- Depois do fechamento: o ticket 11 mudou uma palavra da lista, e o critério 1 ("a lista não muda") valia até ali. `interface` sozinho deixou de contar como tela, e só conta com `web`, `gráfica`, `visual`, `do usuário` ou `de usuário` depois; o motivo foi um falso positivo no ponta a ponta. Ver a nota da decisão **Tela** na spec e os Comments do ticket 11.
