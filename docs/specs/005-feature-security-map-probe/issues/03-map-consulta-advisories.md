...
- [ ] Com o Payload fixado numa versão anterior à correção de um advisory confirmado, o mapa lista o advisory com a versão que corrige
- [ ] Advisory da stack sem item no checklist aparece no mapa como lacuna
- [ ] Advisory de mecanismo aplicável ao código do projeto gera pergunta de variante com arquivo:linha
- [ ] O `profile.md` registra fontes, data e pacotes e versões consultados
- [ ] Sem rede, o map termina e o mapa registra que a consulta externa não foi feita
- [ ] Nenhuma fonte além do OSV.dev e dos advisories do repositório da stack é consultada
