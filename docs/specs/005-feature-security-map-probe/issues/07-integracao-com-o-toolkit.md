...
- [ ] Num projeto Payload, o boot sugere o map com a justificativa de uma linha
- [ ] Recusada a sugestão, o boot termina sem criar `docs/security/`
- [ ] O `anvil-docs` descreve `docs/security/` com `profile.md`, `map.md`, `findings.md` e quem escreve cada um, e o índice gerado lista a pasta quando ela existe
- [ ] O `.claude/rules/project.md` lista `anvil-security-map` e `anvil-security-probe` entre as skills autorais
